...
public final class Encoder implements ActualParameterVisitor<Frame, Integer>,
	...
	// Commands
	@Override
	public Void visitSquareCommand(SquareCommand ast, Frame frame) {
		// Load the variable onto the stack
		encodeFetch(ast.V, frame, Machine.integerSize);

		// Multiply the value by itself
		emitter.emit(OpCode.LOAD, Register.ST, 0);  // Load the top value
		emitter.emit(OpCode.CALL, Register.PB, Primitive.MULT);  // Multiply
