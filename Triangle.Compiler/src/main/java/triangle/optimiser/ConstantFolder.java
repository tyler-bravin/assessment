...
public class ConstantFolder implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
	...
	@Override
	public AbstractSyntaxTree visitSquareCommand(SquareCommand ast, Void arg) {
		// Visit the variable being squared to optimize or transform it
		ast.V.visit(this);

		// Return null as commands generally aren't replaced
		return null;
	}
